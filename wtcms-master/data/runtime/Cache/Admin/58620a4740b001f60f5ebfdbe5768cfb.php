...
<html>
	<head>
		...
		<meta name="robots" content="noindex,nofollow">
			<link href="/php_git/wtcms-master/admin/themes/default/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<video id="video_background" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
		<source src="/php_git/wtcms-master/admin/themes/default/Public/assets/images/time.webm" type="video/webm">
		<source src="/php_git/wtcms-master/admin/themes/default/Public/assets/images/time.mp4" type="video/mp4">
	</video>
	<div class="cover"></div>
