							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<?php if(!empty($site_admin_url_password)): ?><span class="help-block">后台地址：<span id="js-site-admin-url"><?php echo sp_get_host();?>/php_git/wtcms-master?g=admin&upw=<?php echo C('SP_SITE_ADMIN_URL_PASSWORD');?></span></span><?php endif; ?>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span class="help-block">
											不能以/结尾；设置这个地址后，请将Thinkphp下的静态资源文件放在其下面；<br>
											Thinkphp下的静态资源文件大致包含以下(如果你自定义后，请自行增加)：<br>
