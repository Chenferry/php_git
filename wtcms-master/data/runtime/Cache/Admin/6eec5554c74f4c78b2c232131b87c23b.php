...
<link href="/php_git/wtcms-master/public/default/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
<link href="/php_git/wtcms-master/public/default/css/simplebootadmin.css" rel="stylesheet">
<link href="/php_git/wtcms-master/public/default/font-awesome/4.4.0/css/font-awesome.min.css?page=index"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/php_git/wtcms-master/public/default/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/php_git/wtcms-master/public/default/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<link href="/php_git/wtcms-master/public/js/artDialog/skins/default.css" rel="stylesheet" />
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/php_git/wtcms-master/public/default/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-left nav_shortcuts" >
					...
					<a class="btn btn-small btn-warning" href="/php_git/wtcms-master/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<!--<img class="nav-user-photo" width="30" height="30" src="/php_git/wtcms-master/admin/themes/default/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">--><?php endif; ?>
	...
	<script src="/php_git/wtcms-master/public/default/bootstrap/js/bootstrap.min.js"></script>
	<script>
	...
	<script src="/php_git/wtcms-master/public/js/common.js"></script>
	<script src="/php_git/wtcms-master/admin/themes/default/Public/assets/js/index.js"></script>
</body>
</html>