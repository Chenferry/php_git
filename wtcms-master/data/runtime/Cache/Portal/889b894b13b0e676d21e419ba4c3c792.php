...
<head>
    ...
    <link href="/php_git/wtcms-master/public/default/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
...
<body>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:upload_one_image('图片上传','#thumb');">
										<?php if(empty($smeta['thumb'])): ?><img src="/php_git/wtcms-master/admin/themes/default/Public/assets/images/default-thumbnail.png" id="thumb-preview" width="135" style="cursor: hand"/>
										<?php else: ?>
											<img src="<?php echo sp_get_image_preview_url($smeta['thumb']);?>" id="thumb-preview" width="135" style="cursor: hand"/><?php endif; ?>
									</a>
									<input type="button" class="btn btn-small" onclick="$('#thumb-preview').attr('src','/php_git/wtcms-master/admin/themes/default/Public/assets/images/default-thumbnail.png');$('#thumb').val('');return false;" value="取消图片">
								</div>
							</td>
						</tr>
						<tr>
	...
	<script type="text/javascript" src="/php_git/wtcms-master/public/js/common.js"></script>
	<script type="text/javascript">
		//编辑器路径定义
		var editorURL = GV.WEB_ROOT;
	</script>
	<script type="text/javascript" src="/php_git/wtcms-master/public/js/ueditor/ueditor.config.js"></script>
